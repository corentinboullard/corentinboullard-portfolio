const projects = {
  everesting: {
    ...
    embed: 'https://www.youtube-nocookie.com/embed/dancQaFmk1g?autoplay=0&mute=0&controls=1&loop=1&playlist=dancQaFmk1g&playsinline=1&rel=0&iv_load_policy=3',
  ...
  naak: {
    ...
    embed: 'https://www.youtube-nocookie.com/embed/1ZE7xjDqzbY?autoplay=0&mute=0&controls=1&loop=1&playlist=1ZE7xjDqzbY&playsinline=1&rel=0&iv_load_policy=3',
  ...
  pyrene: {
    ...
    embed: 'https://www.youtube-nocookie.com/embed/3moZA3CL6kc?autoplay=0&mute=0&controls=1&loop=1&playlist=3moZA3CL6kc&playsinline=1&rel=0&iv_load_policy=3',
  ...
  'nat-form': {
    ...
    embed: 'https://www.youtube-nocookie.com/embed/F0Kpj2BeIug?autoplay=0&mute=0&controls=1&loop=1&playlist=F0Kpj2BeIug&playsinline=1&rel=0&iv_load_policy=3',
  ...
  'stellar-equipement': {
    ...
    embed: 'https://www.youtube-nocookie.com/embed/SGx2-TlMPHw?autoplay=0&mute=0&controls=1&loop=1&playlist=SGx2-TlMPHw&playsinline=1&rel=0&iv_load_policy=3',
  ...
  'boo-johnson': {
    ...
    embed: 'https://www.youtube-nocookie.com/embed/GyIuSzdbdpY?autoplay=0&mute=0&controls=1&loop=1&playlist=GyIuSzdbdpY&playsinline=1&rel=0&iv_load_policy=3',
  ...
  'lyon-sainte-lyon': {
    ...
    embed: 'https://www.youtube-nocookie.com/embed/gQh4ofhJFeA?autoplay=0&mute=0&controls=1&loop=1&playlist=gQh4ofhJFeA&start=0&end=30&playsinline=1&rel=0&iv_load_policy=3',
