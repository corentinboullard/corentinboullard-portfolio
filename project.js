const projects = {
  everesting: {
    ...
    embed: 'https://www.youtube.com/embed/dancQaFmk1g?autoplay=1&mute=1&controls=1&loop=1&playlist=dancQaFmk1g&playsinline=1&rel=0&cc_load_policy=0&iv_load_policy=3',
  ...
  naak: {
    ...
    embed: 'https://www.youtube.com/embed/1ZE7xjDqzbY?autoplay=1&mute=1&controls=1&loop=1&playlist=1ZE7xjDqzbY&playsinline=1&rel=0&cc_load_policy=0&iv_load_policy=3',
  ...
  pyrene: {
    ...
    embed: 'https://www.youtube.com/embed/3moZA3CL6kc?autoplay=1&mute=1&controls=1&loop=1&playlist=3moZA3CL6kc&playsinline=1&rel=0&cc_load_policy=0&iv_load_policy=3',
  ...
  'nat-form': {
    ...
    embed: 'https://www.youtube.com/embed/F0Kpj2BeIug?autoplay=1&mute=1&controls=1&loop=1&playlist=F0Kpj2BeIug&playsinline=1&rel=0&cc_load_policy=0&iv_load_policy=3',
  ...
  'stellar-equipement': {
    ...
    embed: 'https://www.youtube.com/embed/SGx2-TlMPHw?autoplay=1&mute=1&controls=1&loop=1&playlist=SGx2-TlMPHw&playsinline=1&rel=0&cc_load_policy=0&iv_load_policy=3',
  ...
  'boo-johnson': {
    ...
    embed: 'https://www.youtube.com/embed/GyIuSzdbdpY?autoplay=1&mute=1&controls=1&loop=1&playlist=GyIuSzdbdpY&playsinline=1&rel=0&cc_load_policy=0&iv_load_policy=3',
  ...
  'lyon-sainte-lyon': {
    ...
    embed: 'https://www.youtube.com/embed/gQh4ofhJFeA?autoplay=1&mute=1&controls=1&loop=1&playlist=gQh4ofhJFeA&start=0&end=30&playsinline=1&rel=0&cc_load_policy=0&iv_load_policy=3',
